"""
Django settings for sipbook project.
...
THREEX_BASE_URL = env("THREEX_BASE_URL")
THREEX_CLIENT_ID = env("THREEX_CLIENT_ID")
THREEX_CLIENT_SECRET = env("THREEX_CLIENT_SECRET")

PHONEBOOK_BASE_URL = env("PHONEBOOK_BASE_URL")

UNFOLD = {

    "SITE_TITLE": "PhoneSync",
    "SITE_HEADER": "PhoneSync",
    "SITE_SUBHEADER": "SIP Phonebook Management",
                ...
                "items": [
                    {
                        ...
                        "icon": "contacts",
                        "link": reverse_lazy(
                            "admin:phonebook_phonebookxml_changelist"
                        ),
                    },
                    {
                        "title": _("Access logs"),
                        "icon": "history",
                        "link": reverse_lazy(
                            "admin:phonebook_phonebookaccesslog_changelist"
                        ),
                    },
                ],
            },
...
WSGI_APPLICATION = 'sipbook.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / 'static']          # optional – folder for your custom static files
